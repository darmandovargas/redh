...
$contenido = search_content($oMySQL,'recursos_humanos');
?>
...
<span style="font-family: Helvetica, Arial, Sans-Serif; font-weight: 100">
    ...
    <div id="edit" <?php echo ($_SESSION['sessid']== session_id())?'style="margin-left: 98%;margin-top:0px;'.$edit.'"':'style="display: none;margin-left: 98%;"' ?>>
        <a href="recursos_humanos.php?edit=edit" title="Editar" style="text-decoration: none;"><img src="../img/file_edit.png" width="20" height="20" /></a>
    </div>                    
    <div id="notify" style="margin-top: 10px;"><?php if(isset($_REQUEST['msj'])) {
            echo $_REQUEST['msj']; ?>
    ...
    <div id="recursos_edit" style="height: 450px"><textarea name="editor1" id="editor1" rows="1000" cols="1000">
        ...
        <div id="button" style="margin-right: 0px;margin-top: 10px;">
                    ...
                    <a class="btn" href="javascript:parent.showRecursos();">Cancelar</a>
                </div>
            ...
            function guardar(){
                //var texto = document.getElementById('editor1').value;
                ...
                $.ajax({					
                    ...
                    data: {texto : texto,actionID : 'insert',page : 'recursos_humanos'},
                    success: function(response){
                            // Validar mensaje de error
                            if(response.respuesta == true){ 
                                   window.location.href = "recursos_humanos.php?msj=<div class='exito'>Recursos humanos almacenados correctamente</div>";
                                   $("#msg").hide();
                            }
                    },
    ...
    <?php }else{ ?>
    <div id="recursos_view" style="text-align: left;">
        <?php echo utf8_encode($contenido); ?>
    </div>
    <?php }?>
</span>