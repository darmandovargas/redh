	...
	<body class="bg-cyan">		
		<div class="body">
			...
			<div class="sky-tabs sky-tabs-external sky-tabs-position sky-tabs-pos-top-left sky-tabs-anim-slide-down sky-tabs-response-to-icons">
				<?php
				if(true){//$series['temperaturaJson'] || $series['presionJson'] || $series['humedadJson'] || $series['precipitacionJson'] || $series['nivelJson'] || $series['radiacionJson'] || $series['velocidadJson'] || $series['direccionJson'] || $series['evapotranspiracionJson']){
					$check = "";
				?>
